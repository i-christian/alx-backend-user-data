...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(self,
        ...
        Returns:
            The extracted Base64 authorization header.
        """
    ...
    def user_object_from_credentials(self, user_email: str,
        ...
        Returns:
            The User instance corresponding to the provided email and password.
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        Returns:
            The User instance associated with the request.
        """
